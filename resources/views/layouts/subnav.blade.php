...
@endphp
<nav class="sticky p-1">
    <div class="md:flex justify-between container m-auto">
        <div class=" text-gray-400 text-sm">

            <span>{{$tr->translate('Welcome to CartCraft market !')}}</span>
        </div>
        <div class=" place-content-center font-thin text-gray-400 flex">
            <div class="mx-1">
                <svg class=" inline text-[{{$dark_color}}]" xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" viewBox="0 0 24 24">
                ...
                <span>{{$tr->translate('Fast delivery')}}</span>
                <span>|</span>
            </div>
            ...
            <div class="mx-1">
                ...
                <span class=" font-thin text-gray-400">{{$tr->translate('Best Offers')}}</span>
                <span>|</span>
            </div>
            ...
            <div class="mx-1">
                <svg class=" inline text-[{{$dark_color}}]" xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M13.604 8.4h-3.405V12h3.405a1.8 1.8 0 1 0 0-3.6M12 0C5.372 0 0 5.372 0 12s5.372 12 12 12s12-5.372 12-12S18.628 0 12 0m1.604 14.4h-3.405V18H7.801V6h5.804a4.2 4.2 0 1 1-.001 8.4" />
                </svg>
                <span class=" font-thin text-gray-400">{{$tr->translate('Hight quality')}}</span>
            </div>
