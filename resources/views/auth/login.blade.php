        ...
        <div class="bg-white rounded-tr-3xl rounded-br-3xl p-5 place-content-center">
            <div class="w-[90%] m-auto">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="">
                        <div>
                            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="{{$tr->translate('Enter your Email')}}" />
                            <x-input-error :messages="$errors->get('email')" class="mt-2" />
                        </div>

                        <!-- Password -->
                        <div class="my-2">
                            <x-text-input id="password" class="block mt-1 w-full" type="password" name="password" required autocomplete="current-password" placeholder="{{$tr->translate('Enter password')}}" />
                        ...
                        <div class="block mt-4">
                            <label for="remember_me" class="inline-flex items-center">
                                ...
                                <span class="ms-2 text-sm text-gray-500">{{$tr->translate('remember me')}}</span>
                            </label>
                        </div>
