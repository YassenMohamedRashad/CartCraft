<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <div class="d-flex">
                <input id="male" class="" type="radio" value="1" name="gender" :value="old('Gender')" required />
                <label class="text-white">Male</label>
                <input id="female" class="ml-4" type="radio" value="0" name="gender" :value="old('Gender')" required />
